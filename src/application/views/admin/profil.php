                    ...
                    <div class="white-box">
                        <form class="form-horizontal form-material">
                            <div class="form-group">
                                <label class="col-md-12">ID Admin</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="AD001" class="form-control form-control-line"> </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Keputih Gang 3C No.4" class="form-control form-control-line"> </div>
                            </div>
                            <div class="form-group">
