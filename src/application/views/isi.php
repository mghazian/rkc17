...
<head>
    ...
    <!-- Menu CSS -->
    <link rel="stylesheet" href="<?php base_url ('assets/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css')?>">
    <!--<link rel="stylesheet" href="<?php base_url ('assets/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css')?>">-->
    <!-- toast CSS -->
    <link rel="stylesheet" href="<?php base_url ('assets/plugins/bower_components/toast-master/css/jquery.toast.css')?>">
    <!-- morris CSS -->
    <link rel="stylesheet" href="<?php base_url ('assets/plugins/bower_components/morrisjs/morris.css')?>">
    <!-- chartist CSS -->
    <link rel="stylesheet" href="<?php base_url ('assets/plugins/bower_components/chartist-js/dist/chartist.min.css')?>">
    <link rel="stylesheet" href="<?php base_url ('assets/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css')?>">
    <!-- animation CSS -->
    <link href="css/animate.css')?>">
    <!-- Custom CSS -->
    <link href="css/style.css')?>">
    <!-- color CSS -->
    <link href="css/colors/default.css" id="theme')?>">
